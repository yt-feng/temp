...
Page({
  ...
  //    console.log('view组件中的文本内容为：',res);})
     wx.createSelectorQuery().select('#myview').boundingClientRect().exec(function (res) {
      //var resmy = res[0];
      console.log(res)
      // console.log(resmy.top)
    });
    console.log(">>>>",this.data.list[app.globalData.teacher-1]);
...
this.setData({teacher:e.currentTarget.dataset.index})
},
